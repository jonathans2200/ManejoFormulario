                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="codigo" value="${telefono.codigo}">
                                </div> 
                                <div class="form-group">
                                    <label for="numero">NUMERO</label>
                                    <input type="text" class="form-control" name="numero" value="${telefono.numero}" >
                                </div> 
                                <div class="form-group">
                                    <label for="codigo">TIPO</label>
                                    <input type="text" class="form-control" name="tipo" value="${telefono.tipo}" >
                                </div> 
                                <div class="form-group">
                                    <label for="codigo">OPERADORA</label>
                                    <input type="text" class="form-control" name="operador" value="${telefono.operadora}">
                                </div> 
                                </form>
